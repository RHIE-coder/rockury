import { STATUS_LABEL, type CompareField, type NodeTypeDef } from '../catalog/types'
import type { DesignNode } from '../design/types'
import { matchResources } from './match'
import type { LiveResource, MatchBasis, Verdict } from './types'
...
export function reconcile(input: ReconcileInput): DiffRow[] {
  ...
  for (const m of matches) {
    const node = byId.get(m.designNodeId) as DesignNode
