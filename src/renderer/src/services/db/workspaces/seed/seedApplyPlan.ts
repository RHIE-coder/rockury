import { buildDelete, buildInsert, buildUpdate, pkColumns, type SqlDialect, type Statement } from '../../console/data/sqlBuilder'
...
/**
 * **설계 → 운영 반영 계획**(순수) — 정본 `docs/spec/db-studio.md` Section `db-studio.seed.apply-contract`.
 *
