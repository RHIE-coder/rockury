...
import { DiagramSurface } from '../../console/diagram/DiagramSurface'
import { useDiagramLayout } from '../../console/diagram/useDiagramLayout'
 ...
 * 관계는 컬럼 핸들을 끌어 생성. 배치·그룹·상세 서랍은 Console ERD 와 **같은 공용 표면**을 쓰고,
 * 저장 스코프만 설계별(`design:<id>`)이다. 정본: `docs/spec/db-studio.md` §db-studio.diagram.scope.
 */
export function StudioDiagramWorkspace() {
  ...
  // 정본이 바뀌면 안 된다(정본 §db-studio.diagram.scope AC-2).
