...
/**
 * Remote › History — Query/Data/Collection 실행·Definition(스키마 편집) 이력(다중 소스). 독립 뷰.
...
export function HistoryView() {
  ...
  if (!conn) {
    return <PlaceholderView icon={HistoryIcon} depth="depth 3 · Remote › History" title="연결을 선택하세요" subtitle="Connection 셀렉터에서 대상을 고르면 실행 이력을 볼 수 있습니다." />
  }
