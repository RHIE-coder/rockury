-- =============================================================================
-- MySQL 범위(scope) 시연 데이터 — §db-remote.scope
-- Target: Docker MySQL 8 (port 13306, user=test, password=test)
--
-- MySQL 은 database 와 schema 가 **같은 말**이다. 그리고 PostgreSQL 과 결정적으로 다른 점:
